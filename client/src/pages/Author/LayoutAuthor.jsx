        ...
        <>
            ...
            <div className={'grid grid-cols-2'}>
                        ...
                        <li className={'text-sm font-semobold text-amber-600 py-4 border-b border-gray-300 px-5 space-x-2'}>
                            <div className={`flex items-center justify-between`}>
                                ...
                                <div className={'icon-close'}>
                                    <i onClick={handleCloseNav}
                                       className={`fa-solid fa-close text-xl text-amber-600 cursor-pointer float-right`}></i>
                                </div>
                            </div>
                        </li>
                        <li className={'text-sm font-semobold text-amber-600 py-4 border-b border-gray-300 cursor-pointer px-5 space-x-2'}>
                            <div onClick={handleCollapse} className={`flex items-center justify-between`}>
                                <div className={`space-x-2`}>
                                    ...
                                    <Link to={'#'} className={'font-lighter font-bold text-sm text-gray-700'}>BẢN
                                        THẢO</Link>
                                </div>
                            ...
                            <div className={`${collapse ? 'block' : 'hidden'}`}>
                                <ul className={'items-start'}>
                                    <li className={'text-sm font-semobold text-amber-600 py-3 space-x-2'}>
                                        <Link to={'#'} className={'font-lighter text-sm text-gray-700'}>THÊM BẢN
                                            THẢO</Link>
                                    </li>
                                    <li className={'text-sm font-semobold text-amber-600 py-3 space-x-2'}>
                                        <Link to={'#'} className={'font-lighter text-sm text-gray-700'}>CÁC BẢN
                                            THẢO</Link>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li className={'text-sm font-semobold text-amber-600 py-4 border-b border-gray-300 cursor-pointer px-5 space-x-2'}>
                            <div onClick={handleListBook} className={`flex items-center justify-between `}>
                                <div className={`space-x-2`}>
                                    ...
                                    <Link to={'#'} className={'font-lighter font-bold text-sm text-gray-700'}>SÁCH
                                        TRUYỆN</Link>
                                </div>
                            ...
                            <div className={`${listBook ? 'block' : 'hidden'}`}>
                                <ul className={'items-start'}>
                                    <li className={'text-sm font-semobold text-amber-600 py-3 space-x-2'}>
                                        <Link to={'createbook'} className={'font-lighter text-sm text-gray-700'}>THÊM TRUYỆN
                                            MỚI</Link>
                                    </li>
                                    <li className={'text-sm font-semobold text-amber-600 py-3 space-x-2'}>
                                        <Link to={'#'} className={'font-lighter text-sm text-gray-700'}>TRUYỆN CỦA
                                            TÔI</Link>
                                    </li>
                                    <li className={'text-sm font-semobold text-amber-600 py-3 space-x-2'}>
                                        <Link to={'#'} className={'font-lighter text-sm text-gray-700'}>BÁO
                                            LỖI</Link>
                                    </li>
                                    <li className={'text-sm font-semobold text-amber-600 py-3 space-x-2'}>
                                        <Link to={'#'} className={'font-lighter text-sm text-gray-700'}>THỐNG
                                            KÊ</Link>
                                    </li>
                                    <li className={'text-sm font-semobold text-amber-600 py-3 space-x-2'}>
                                        <Link to={'#'} className={'font-lighter text-sm text-gray-700'}>TƯ
                                            LIỆU</Link>
                                    </li>
                                </ul>
                            </div>
                ...
                <div className={'absolute w-full'}>
                    <nav
                        className={`sticky-nav-author bg-white flex justify-between items-center px-3 py-2 border-b w-full float-right toggle-nav-style ${CloseNav ? 'admin-content-right toggle-nav-style' : 'w-full toggle-nav-style'}`}>
                        <div className={'space-x-5'}>
                            <i onClick={handleCloseNav}
                               className={`${CloseNav ? 'fas fa-align-left' : 'fas fa-bars'} cursor-pointer text-xl text-amber-600`}></i>
                        </div>
                    ...
                    <div
                        className={`overflow-y-scroll bg-gray-100 items-center px-3 py-2 w-full float-right toggle-nav-style ${CloseNav ? 'admin-content-right toggle-nav-style' : 'w-full toggle-nav-style'}`}>
